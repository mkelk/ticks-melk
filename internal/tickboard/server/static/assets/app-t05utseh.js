 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const er=(t,e)=>(t==null?void 0:t._$litType$)!==void 0,Hs=t=>t.strings===void 0,ir={},sr=(t,e=ir)=>t._$AH=e;var ye=Symbol(),Me=Symbol(),mi,bi=new Map,J=class extends D{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var i;let s;if(e!=null&&e.spriteSheet)return this.svg=u`<svg part="svg">
...
`,De=class extends D{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return u`
      <span
        part="base"
    ...
    `}};De.styles=[R,_a];n([l({reflect:!0})],De.prototype,"variant",2);n([l({type:Boolean,reflect:!0})],De.prototype,"pill",2);n([l({type:Boolean,reflect:!0})],De.prototype,"pulse",2);De.define("sl-badge");var Ca=E`
  :host {
    display: contents;
...
`,Ka=0,Pe=class extends D{constructor(){super(...arguments),this.attrId=++Ka,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return u`
      <slot
        part="base"
        class=${P({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Pe.styles=[R,qa];n([l({reflect:!0})],Pe.prototype,"name",2);n([l({type:Boolean,reflect:!0})],Pe.prototype,"active",2);n([$("active")],Pe.prototype,"handleActiveChange",1);Pe.define("sl-tab-panel");/**
 * @license
