import{i as m,n as l,a as v,b as n,t as f,e as M,r as h}from"./ticks-logo-DYgrblNn.js";var U=Object.defineProperty,G=Object.getOwnPropertyDescriptor,p=(e,t,s,i)=>{for(var o=i>1?void 0:i?G(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&U(t,s,o),o};let c=class extends v{constructor(){super(...arguments),this.label="",this.placeholder="",this.type="text",this.value="",this.name="",this.size="medium",this.disabled=!1,this.required=!1,this.error=!1,this.errorMessage=""}handleInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0}))}handleChange(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return n`
  ...
  `;p([l({type:String})],c.prototype,"label",2);p([l({type:String})],c.prototype,"placeholder",2);p([l({type:String})],c.prototype,"type",2);p([l({type:String})],c.prototype,"value",2);p([l({type:String})],c.prototype,"name",2);p([l({type:String,reflect:!0})],c.prototype,"size",2);p([l({type:Boolean})],c.prototype,"disabled",2);p([l({type:Boolean})],c.prototype,"required",2);p([l({type:Boolean,reflect:!0})],c.prototype,"error",2);p([l({type:String})],c.prototype,"errorMessage",2);p([l({type:Number})],c.prototype,"minlength",2);p([l({type:Number})],c.prototype,"maxlength",2);c=p([f("ticks-input")],c);var F=Object.defineProperty,H=Object.getOwnPropertyDescriptor,T=(e,t,s,i)=>{for(var o=i>1?void 0:i?H(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&F(t,s,o),o};let g=class extends v{constructor(){super(...arguments),this.variant="neutral",this.dot=!1,this.pill=!1}render(){return n`
  ...
  `;T([l({type:String})],g.prototype,"variant",2);T([l({type:Boolean})],g.prototype,"dot",2);T([l({type:Boolean})],g.prototype,"pill",2);g=T([f("ticks-badge")],g);var J=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,P=(e,t,s,i)=>{for(var o=i>1?void 0:i?Y(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&J(t,s,o),o};let x=class extends v{constructor(){super(...arguments),this.interactive=!1,this.bordered=!1}render(){return n`
  ...
  `;P([l({type:Boolean})],x.prototype,"interactive",2);P([l({type:Boolean})],x.prototype,"bordered",2);x=P([f("ticks-card")],x);var V=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,R=(e,t,s,i)=>{for(var o=i>1?void 0:i?Q(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&V(t,s,o),o};let D=class extends v{constructor(){super(...arguments),this.size="medium"}render(){return n`
      <div
  ...
  `;$([l({type:Boolean,reflect:!0})],b.prototype,"open",2);$([l({type:Boolean})],b.prototype,"closeOnBackdrop",2);$([l({type:Boolean})],b.prototype,"closeOnEscape",2);$([M(".dialog")],b.prototype,"dialogEl",2);b=$([f("ticks-dialog")],b);var Z=Object.getOwnPropertyDescriptor,ee=(e,t,s,i)=>{for(var o=i>1?void 0:i?Z(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=a(o)||o);return o};let O=class extends v{renderDefaultIcon(){return n`
  ...
  `;O=ee([f("ticks-empty-state")],O);var te=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,I=(e,t,s,i)=>{for(var o=i>1?void 0:i?oe(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&te(t,s,o),o};let C=class extends v{constructor(){super(...arguments),this.interactive=!1}handleClick(e){this.interactive&&this.dispatchEvent(new CustomEvent("click",{detail:{originalEvent:e},bubbles:!0,composed:!0}))}render(){return n`
      <div
  ...
  `;I([l({type:Boolean})],C.prototype,"interactive",2);C=I([f("ticks-list-item")],C);var ie=Object.defineProperty,se=Object.getOwnPropertyDescriptor,K=(e,t,s,i)=>{for(var o=i>1?void 0:i?se(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&ie(t,s,o),o};let S=class extends v{constructor(){super(...arguments),this.sticky=!1}render(){return n`
      <header>
        <div class="logo">
          <slot name="logo"></slot>
        </div>
  ...
  `;K([l({type:Boolean,reflect:!0})],S.prototype,"sticky",2);S=K([f("ticks-header")],S);var re=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,E=(e,t,s,i)=>{for(var o=i>1?void 0:i?ae(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&re(t,s,o),o};let y=class extends v{constructor(){super(...arguments),this.block=!1,this.copyable=!1,this.copied=!1}async handleCopy(){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("slot"),s=((e==null?void 0:e.assignedNodes({flatten:!0}))||[]).map(o=>o.textContent).join("").trim();try{await navigator.clipboard.writeText(s),this.copied=!0,setTimeout(()=>{this.copied=!1},2e3)}catch(o){console.error("Failed to copy:",o)}}render(){return this.block?n`
      ...
      `:n`<code><slot></slot></code>`}};y.styles=m`
    :host {
      display: inline;
    }
  ...
  `;E([l({type:Boolean,reflect:!0})],y.prototype,"block",2);E([l({type:Boolean})],y.prototype,"copyable",2);E([h()],y.prototype,"copied",2);y=E([f("ticks-code")],y);var ne=Object.defineProperty,le=Object.getOwnPropertyDescriptor,u=(e,t,s,i)=>{for(var o=i>1?void 0:i?le(t,s):t,r=e.length-1,a;r>=0;r--)(a=e[r])&&(o=(i?a(t,s,o):a(o))||o);return i&&o&&ne(t,s,o),o};let d=class extends v{constructor(){super(...arguments),this.authState="loading",this.authTab="login",this.authError="",this.userEmail="",this.view="dashboard",this.boards=[],this.tokens=[],this.newToken="",this.showCreateToken=!1,this.confirmDialog={open:!1,title:"",message:"",action:null},this.token=""}connectedCallback(){super.connectedCallback(),this.token=localStorage.getItem("token")||"",this.userEmail=localStorage.getItem("userEmail")||"",this.token?this.checkAuth():(this.authState="unauthenticated",this.updateUrl())}updateUrl(){const e=this.authState==="authenticated"?"/app":"/login";window.location.pathname!==e&&history.replaceState(null,"",e)}async checkAuth(){try{const e=await fetch("/api/boards",{headers:{Authorization:`Bearer ${this.token}`}});if(e.ok){const t=await e.json();this.boards=t.boards||[],this.authState="authenticated",this.loadTokens()}else this.clearAuth()}catch(e){console.error("Auth check failed:",e),this.clearAuth()}this.updateUrl()}clearAuth(){localStorage.removeItem("token"),localStorage.removeItem("userEmail"),this.token="",this.userEmail="",this.authState="unauthenticated"}async loadBoards(){try{const e=await fetch("/api/boards",{headers:{Authorization:`Bearer ${this.token}`}});if(e.ok){const t=await e.json();this.boards=t.boards||[]}}catch(e){console.error("Failed to load boards:",e)}}async loadTokens(){try{const e=await fetch("/api/tokens",{headers:{Authorization:`Bearer ${this.token}`}});if(e.ok){const t=await e.json();this.tokens=t.tokens||[]}}catch(e){console.error("Failed to load tokens:",e)}}handleLoginKeydown(e){var t;if(e.key==="Enter"){e.preventDefault();const s=(t=this.shadowRoot)==null?void 0:t.querySelector("#login-form");s&&s.requestSubmit()}}handleSignupKeydown(e){var t;if(e.key==="Enter"){e.preventDefault();const s=(t=this.shadowRoot)==null?void 0:t.querySelector("#signup-form");s&&s.requestSubmit()}}async handleLogin(e){var r,a;e.preventDefault();const t=(r=this.shadowRoot)==null?void 0:r.querySelector('ticks-input[name="email"]'),s=(a=this.shadowRoot)==null?void 0:a.querySelector('ticks-input[name="password"]'),i=(t==null?void 0:t.value)||"",o=(s==null?void 0:s.value)||"";this.authError="";try{const k=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,password:o})}),w=await k.json();if(!k.ok){this.authError=w.error||"Login failed";return}this.token=w.token,this.userEmail=i,localStorage.setItem("token",this.token),localStorage.setItem("userEmail",this.userEmail),this.authState="authenticated",this.updateUrl(),this.loadBoards(),this.loadTokens()}catch{this.authError="Login failed. Please try again."}}async handleSignup(e){var w,z,j,B;e.preventDefault();const t=(w=this.shadowRoot)==null?void 0:w.querySelector("form:not(#login-form)"),s=t==null?void 0:t.querySelector('ticks-input[name="email"]'),i=t==null?void 0:t.querySelector('ticks-input[name="password"]'),o=t==null?void 0:t.querySelector('ticks-input[name="confirm"]'),r=(s==null?void 0:s.value)||"",a=(i==null?void 0:i.value)||"",k=(o==null?void 0:o.value)||"";if(this.authError="",a!==k){this.authError="Passwords do not match";return}try{const _=await fetch("/api/auth/signup",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:r,password:a})}),N=await _.json();if(!_.ok){this.authError=N.error||"Signup failed";return}this.authTab="login",await this.updateComplete;const A=(z=this.shadowRoot)==null?void 0:z.querySelector('#login-form ticks-input[name="email"]'),q=(j=this.shadowRoot)==null?void 0:j.querySelector('#login-form ticks-input[name="password"]');A&&(A.value=r),q&&(q.value=a);const L=(B=this.shadowRoot)==null?void 0:B.querySelector("#login-form");L&&L.requestSubmit()}catch{this.authError="Signup failed. Please try again."}}handleLogout(){fetch("/api/auth/logout",{method:"POST"}),this.clearAuth(),this.updateUrl()}openBoard(e,t){if(!t){this.showAlert("Board Offline","This board is offline. Start it with: tk run --cloud");return}window.location.href=`/p/${encodeURIComponent(e)}/`}showAlert(e,t){this.confirmDialog={open:!0,title:e,message:t,action:null}}async createToken(){var s;const e=(s=this.shadowRoot)==null?void 0:s.querySelector("#new-token-name"),t=((e==null?void 0:e.value)||"").trim();if(t)try{const i=await fetch("/api/tokens",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.token}`},body:JSON.stringify({name:t})}),o=await i.json();i.ok&&(this.newToken=o.token,this.showCreateToken=!1,this.loadTokens())}catch(i){console.error("Failed to create token:",i)}}revokeToken(e){this.confirmDialog={open:!0,title:"Revoke Token",message:"Are you sure you want to revoke this token? Any clients using it will be disconnected.",action:async()=>{try{await fetch(`/api/tokens/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${this.token}`}}),this.loadTokens()}catch(t){console.error("Failed to revoke token:",t)}}}}removeBoard(e,t){const s=t.replace(/--/g,"/");this.confirmDialog={open:!0,title:"Remove Board",message:`Remove "${s}" from your dashboard? The board can reconnect later.`,action:async()=>{try{const i=await fetch(`/api/boards/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${this.token}`}});if(!i.ok){const o=await i.json();throw new Error(o.error||"Failed to remove board")}this.loadBoards()}catch(i){console.error("Failed to remove board:",i)}}}}closeConfirmDialog(){this.confirmDialog={...this.confirmDialog,open:!1}}async confirmDialogAction(){this.confirmDialog.action&&await this.confirmDialog.action(),this.closeConfirmDialog()}formatDate(e){return e?new Date(e*1e3).toLocaleDateString():"Never"}render(){return this.authState==="loading"?n`
    ...
    `}renderDashboard(){const e=this.boards.filter(t=>t.online);return n`
      <ticks-header>
        <a href="/" slot="logo" style="text-decoration: none;">
          <ticks-logo variant="logotype" .size=${24}></ticks-logo>
        </a>
        ...
        <section class="section">
          ...
          `:n`
            <div class="board-list">
              ${e.map(t=>n`
                <ticks-list-item interactive @click=${()=>this.openBoard(t.name,t.online)}>
                  <ticks-badge slot="status" variant="green" dot></ticks-badge>
                  <span slot="title">${t.name.replace(/--/g,"/")}</span>
  ...
  `;u([h()],d.prototype,"authState",2);u([h()],d.prototype,"authTab",2);u([h()],d.prototype,"authError",2);u([h()],d.prototype,"userEmail",2);u([h()],d.prototype,"view",2);u([h()],d.prototype,"boards",2);u([h()],d.prototype,"tokens",2);u([h()],d.prototype,"newToken",2);u([h()],d.prototype,"showCreateToken",2);u([h()],d.prototype,"confirmDialog",2);d=u([f("ticks-app")],d);
