...
`;function S(e,t){const i=qe({waitUntilFirstUpdate:!1},t);return(s,r)=>{const{update:o}=s,a=Array.isArray(e)?e:[e];s.update=function(n){a.forEach(c=>{const u=c;if(n.has(u)){const p=n.get(u),f=this[u];p!==f&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[r](p,f)}}),o.call(this,n)}}}/**
 * @license
