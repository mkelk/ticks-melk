...
Format: Problem → Cause → Rule under category headers. Size budget 16384 bytes, ≤800 bytes
per entry — compact at every epic retro. Process-level (cross-repo) learnings belong in the ticks skill, not here — see
