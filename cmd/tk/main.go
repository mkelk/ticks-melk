...
func run(args []string) int {
	...
	switch args[1] {
	case "init", "whoami", "show", "create", "update", "close", "reopen", "delete", "block", "unblock", "note", "notes", "list", "ready", "next", "blocked", "label", "labels", "deps", "status", "rebuild", "merge-file", "stats", "view", "snippet", "import", "approve", "reject", "version", "upgrade":
...
func runCreate(args []string) int {
	...
	typeFlag := fs.String("type", tick.TypeTask, "type (task|epic|bug|feature|chore)")
	fs.StringVar(typeFlag, "t", tick.TypeTask, "type (task|epic|bug|feature|chore)")
...
func runList(args []string) int {
	...
	typeFlag := fs.String("type", "", "type (task|epic|bug|feature|chore)")
	fs.StringVar(typeFlag, "t", "", "type (task|epic|bug|feature|chore)")
